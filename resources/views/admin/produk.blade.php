...
<body>
    ...
    <div class="card p-4">
        <div class="d-flex justify-content-between mb-3">
            <a href="{{ route('admin.produk.create') }}" class="btn btn-primary">Add New</a>
        </div>
            ...
            <tbody>
                @forelse ($produk as $index => $p)
                    <tr>
                        <td>{{ $index + 1 }}.</td>
                        <td>
                            <a href="{{ route('admin.produk.edit', $p->id) }}" class="btn btn-sm btn-info me-1">
                                <i class="fas fa-edit"></i>
                            </a>
                            
                            <a href="{{ route('admin.produk.destroy', $p->id) }}" 
